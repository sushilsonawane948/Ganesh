...
public class parameterization_firefox {
	...
	public void OpenBrowser() {
		...
		System.out.println("Firefox Browser setup succesfully");
	}
	...
	Thread.sleep(2000);
    WebElement title= driver.findElement(By.xpath("(//a[contains(text(),'Welcome, Sushil')])[2]"));
    String titletext= title.getText();
    System.out.println("User Name: "+titletext);
   
    String WelcomePage= "Welcome, Sushil";
		if(titletext.equals(WelcomePage)){
